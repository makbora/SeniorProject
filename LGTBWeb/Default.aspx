...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="height: 576px; width: 1120px">
        <div style="float:left;width:191px; ">
            ...
            <br />
            <asp:ListBox ID="GenreBox" runat="server" DataSourceID="GenreDS" DataTextField="kind" DataValueField="kind" Height="263px" SelectionMode="Multiple" Width="184px" AppendDataBoundItems="True">
        ...
        <div style="float:left;width:924px; height: 613px;">
            ...
            <asp:GridView ID="RecipeTable" runat="server" Width="757px" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="RecipesDS" Height="536px" EnableSortingAndPagingCallbacks="True">
                <Columns>
